...
{
    int i;
    for (i = 0; i < len; i++) printf("%x ", str[i]);
    putchar('\n');
}
...
int main(int argc, char *argv[])
{
    ...
    for (i = 0; i < 10; i++) putchar(alphas[i]);
    putchar('\n');
    ...
    for (i = 0; i < 50; i++) printf("%d ", runi[i]);
    putchar('\n');

    for (i = 0; i < 50; i++) printf("%d ", nnums[i]);
    putchar('\n');
    ...
    printf("range: ");
    for (i = 0, len = ((e - s) / st); i < len; i++) printf("%d ", r1[i]);
    putchar('\n');
